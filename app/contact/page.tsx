...
const Contact = () => {
  ...
  const handleFields = (field: keyof FormData, value: string) => {
    setForm((prev) => ({
      ...prev,
      [field]: value,
    }));
                  ...
                  <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e: ChangeEvent<HTMLInputElement>) =>
                            handleFields("firstName", e.target.value)
                          }
                          placeholder="John"
                      ...
                      <div>
                        ...
                        <Input
                          value={form.lastName}
                          onChange={(e: ChangeEvent<HTMLInputElement>) =>
                            handleFields("lastName", e.target.value)
                          }
                          placeholder="Doe"
                          className="border-border/30"
                        />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        value={form.email}
                        onChange={(e: ChangeEvent<HTMLInputElement>) =>
                          handleFields("email", e.target.value)
                        }
                    ...
                    <div>
                      ...
                      <Input
                        value={form.subject}
                        onChange={(e: ChangeEvent<HTMLInputElement>) =>
                          handleFields("subject", e.target.value)
                        }
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e: ChangeEvent<HTMLTextAreaElement>) =>
                          handleFields("message", e.target.value)
                        }
              ...
              <ScrollReveal direction="right">
                <div>
                  ...
                  <p className="text-tertiary/70 leading-relaxed">
                    ...
                    Our team is ready to assist you in your startup journey.
                  </p>
                </div>
              </ScrollReveal>
